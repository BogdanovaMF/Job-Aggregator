...
def get_vacancy_data(link: str) -> Tuple[str]:
    ...
    logging.info(f'Получаем инфомарцию по вакансии {vacancy_name}, компания "{company.strip()}"')
...
if __name__ == '__main__':
    ...
    number_page = 0
    args = parse_args()
    url = f'https://hh.ru/vacancies/{args["name"]}?customDomain=1&page={number_page}'
    ...
    html_sel = Selector(job_hh.content.decode('utf-8')).xpath('//html')[0]
